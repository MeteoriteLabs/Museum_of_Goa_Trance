...
export const NOTABLE_PEOPLE: NotablePerson[] = [
  ...
  },
  {
    ...
    contribution: "Indian session musician whose 1982 album \u201CSynthesizing: Ten Ragas to a Disco Beat\u201D used Roland TB-303 and TR-808 to fuse Indian ragas with electronic beats, predating Chicago acid house by five years.",
    era: "pioneers",
    years: "1982",
    link: "https://en.wikipedia.org/wiki/Charanjit_Singh_(musician)",
    chapter: "chapter-2",
  },
  {
    name: "Tsuyoshi Suzuki",
    role: "Label Founder & DJ",
    contribution: "Tokyo-born DJ who co-founded Matsuri Productions in London (1992), one of the defining Goa trance labels. His project Prana released the landmark album Cyclone (1996), helping spread the genre across Japan and East Asia.",
    era: "architects",
    years: "1992\u2013present",
    link: "https://www.discogs.com/artist/47436-Tsuyoshi-Suzuki",
    chapter: "chapter-3",
  },
  {
    name: "Man With No Name",
    role: "Producer & DJ",
    contribution: "Martin Freeland\u2019s track \u201CTeleport\u201D (1994) became a genre-defining anthem. His album Moment of Truth (1996) on XL Recordings helped bring Goa trance to mainstream UK charts via Paul Oakenfold\u2019s Perfecto label.",
    era: "architects",
    years: "1990\u2013present",
    link: "https://en.wikipedia.org/wiki/Martin_Freeland",
    chapter: "chapter-3",
  },
  {
    name: "Mark Allen",
    role: "Promoter & Label Founder",
    contribution: "Co-founded Return to the Source (1993\u20132002), London\u2019s legendary Goa trance club night at venues like The Fridge in Brixton. Its compilation series helped introduce Goa trance to mainstream audiences across the UK.",
    era: "architects",
    years: "1993\u20132002",
    link: "https://www.discogs.com/artist/67493-Mark-Allen",
    chapter: "chapter-3",
  },
  {
    name: "Transwave",
    role: "Producers",
    contribution: "French duo Fr\u00e9d\u00e9ric Holyszewski and Christof Drouillet whose albums Hypnorhythm (1995) and Helium (1996) defined the melodic Goa trance sound. After splitting in 1997, both founded influential psytrance labels.",
    era: "architects",
    years: "1994\u20131997",
    link: "https://en.wikipedia.org/wiki/Transwave",
    chapter: "chapter-3",
  },
  {
    name: "Electric Universe",
    role: "Producers & Live Act",
    contribution: "German duo Boris Blenn and Michael Dressler whose tracks like \u201CCosmic Experience\u201D became enduring Goa trance anthems. Active since the mid-1990s golden era, bridging classic Goa sound with modern psytrance.",
    era: "architects",
    years: "1994\u2013present",
    link: "https://www.discogs.com/artist/2498-Electric-Universe",
    chapter: "chapter-3",
  },
];
